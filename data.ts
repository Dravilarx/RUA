...
const placeholderUser = 'data:image/svg+xml;base64,';
...
export const initialStudents: Student[] = [
  { id: 1, name: 'Ana', lastName: 'González', rut: '19.123.456-7', email: 'ana.gonzalez@email.com', photo: placeholderUser, admissionDate: '2022-03-01', phone: '+56912345678', undergradUniversity: 'Universidad de Chile', nationality: 'Chilena', birthDate: '1998-03-15' },
  { id: 2, name: 'Luis', lastName: 'Martínez', rut: '20.987.654-3', email: 'luis.martinez@email.com', photo: placeholderUser, admissionDate: '2023-03-01', phone: '+56987654321', undergradUniversity: 'P. Universidad Católica', nationality: 'Chilena', birthDate: '1999-11-20' },
  { id: 3, name: 'Carla', lastName: 'Soto', rut: '21.456.789-K', email: 'carla.soto@email.com', photo: placeholderUser, admissionDate: '2024-03-01', phone: '+56911223344', undergradUniversity: 'Universidad de Concepción', nationality: 'Chilena', birthDate: '2000-07-01' },
  { id: 4, name: 'Diego', lastName: 'Rojas', rut: '19.888.777-6', email: 'diego.rojas@email.com', photo: placeholderUser, admissionDate: '2022-03-01', phone: '+56922334455', undergradUniversity: 'Universidad de Valparaíso', nationality: 'Chilena', birthDate: '1997-08-22' },
  { id: 5, name: 'Valentina', lastName: 'Flores', rut: '20.555.444-1', email: 'valentina.flores@email.com', photo: placeholderUser, admissionDate: '2023-03-01', phone: '+56933445566', undergradUniversity: 'Universidad Austral de Chile', nationality: 'Chilena', birthDate: '1999-01-30' },
];

export const initialTeachers: Teacher[] = [
  { id: 1, name: 'Ricardo', lastName: 'Pérez', rut: '12.345.678-9', photo: placeholderUser, admissionDate: '2010-03-01', contractType: 'Planta', academicRank: 'Titular', postgradUniversity: 'Stanford University', email: 'ricardo.perez@grua.cl', phone: '+56955667788', birthDate: '1975-05-10' },
  { id: 2, name: 'Mónica', lastName: 'Herrera', rut: '14.876.543-2', photo: placeholderUser, admissionDate: '2015-03-15', contractType: 'Honorarios', academicRank: 'Adjunto', postgradUniversity: 'Harvard University', email: 'monica.herrera@grua.cl', phone: '+56933445566', birthDate: '1982-09-25' },
  { id: 3, name: 'Carolina', lastName: 'Lagos', rut: '15.111.222-3', photo: placeholderUser, admissionDate: '2018-08-01', contractType: 'Planta', academicRank: 'Adjunto', postgradUniversity: 'Universidad de Chile', email: 'carolina.lagos@grua.cl', phone: '+56944556677', birthDate: '1985-12-05' },
];
